    ...
    <PageTransition className="page container contacto-page">
      ...
      >
        <motion.div className="contacto-header" variants={itemVariants}>
          ...
          <h1 className="contacto-title">Iniciemos una <br/><span className="text-gradient">conversación</span></h1>
        ...
        <motion.div className="contacto-cards" variants={itemVariants}>
          <a href="mailto:felipe.jaramillo17@gmail.com" className="contact-card glass group">
          ...
          <a href="https://www.linkedin.com/in/felipejaramilloballadares/" target="_blank" rel="noreferrer" className="contact-card glass group">
            <div className="card-icon">
